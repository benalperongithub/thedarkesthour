...
VERIFY_UNIT="/tmp/strategy-lab-supervisor-v2.1-v278-verify-${STAMP}.service"
PREFLIGHT_LOG="/tmp/tdh-v2.0.78-activation-preflight.log"
UNIT_UPDATED=false
ACTIVATION_MODE=""
...
echo "===== 4. INSTALL UNIT AND START v2.0.78 ====="
if [[ "$ACTIVATION_MODE" == "UPDATE_FROM_OLD" ]]; then
...
echo "===== 5. VERIFY RUNTIME SURVIVES DIVERSIFICATION BRIDGE BOUNDARY ====="
sleep 180
test "$(systemctl is-active "$SERVICE")" = "active"
...
echo "TDH_V278_ACTIVATION_COMPLETE"
