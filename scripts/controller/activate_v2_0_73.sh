...
VERIFY_UNIT="/tmp/strategy-lab-supervisor-v2.1-v273-verify-${STAMP}.service"
PREFLIGHT_LOG="/tmp/tdh-v2.0.73-activation-preflight.log"
UNIT_UPDATED=false
ACTIVATION_MODE=""
...
echo "===== 4. INSTALL UNIT AND START v2.0.73 ====="
if [[ "$ACTIVATION_MODE" == "UPDATE_FROM_OLD" ]]; then
...
echo "===== 5. VERIFY RUNTIME SURVIVES PAST PRIOR SCHEMA BOUNDARY ====="
sleep 120
test "$(systemctl is-active "$SERVICE")" = "active"
...
echo "TDH_V273_ACTIVATION_COMPLETE"
