...
VERIFY_UNIT="/tmp/strategy-lab-supervisor-v2.1-v261-verify-${STAMP}.service"
PREFLIGHT_LOG="/tmp/tdh-v2.0.61-activation-preflight.log"
UNIT_UPDATED=false
ACTIVATION_MODE=""
...
echo "===== 4. INSTALL UNIT AND START v2.0.61 ====="
if [[ "$ACTIVATION_MODE" == "UPDATE_FROM_OLD" ]]; then
...
echo "===== 5. VERIFY RUNTIME SURVIVES AND STARTS S1 ====="
sleep 30
test "$(systemctl is-active "$SERVICE")" = "active"
...
echo "TDH_V261_ACTIVATION_COMPLETE"
