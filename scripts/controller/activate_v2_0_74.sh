...
VERIFY_UNIT="/tmp/strategy-lab-supervisor-v2.1-v274-verify-${STAMP}.service"
PREFLIGHT_LOG="/tmp/tdh-v2.0.74-activation-preflight.log"
UNIT_UPDATED=false
ACTIVATION_MODE=""
...
echo "===== 4. INSTALL UNIT AND START v2.0.74 ====="
if [[ "$ACTIVATION_MODE" == "UPDATE_FROM_OLD" ]]; then
...
echo "===== 5. VERIFY RUNTIME SURVIVES PAST GLOBAL-MEMORY DUPLICATE BOUNDARY ====="
sleep 180
test "$(systemctl is-active "$SERVICE")" = "active"
...
echo "TDH_V274_ACTIVATION_COMPLETE"
