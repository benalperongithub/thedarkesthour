...
VERIFY_UNIT="/tmp/strategy-lab-supervisor-v2.1-v280-verify-${STAMP}.service"
PREFLIGHT_LOG="/tmp/tdh-v2.0.80-activation-preflight.log"
UNIT_UPDATED=false
ACTIVATION_MODE=""
...
echo "===== 4. INSTALL UNIT AND START v2.0.80 ====="
if [[ "$ACTIVATION_MODE" == "UPDATE_FROM_OLD" ]]; then
...
print('V280_RUNTIME_POST_S1_HEADROOM_OK')
PY
...
echo "TDH_V280_ACTIVATION_COMPLETE"
