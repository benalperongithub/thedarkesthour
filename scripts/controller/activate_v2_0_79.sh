...
VERIFY_UNIT="/tmp/strategy-lab-supervisor-v2.1-v279-verify-${STAMP}.service"
PREFLIGHT_LOG="/tmp/tdh-v2.0.79-activation-preflight.log"
UNIT_UPDATED=false
ACTIVATION_MODE=""
...
echo "===== 4. INSTALL UNIT AND START v2.0.79 ====="
if [[ "$ACTIVATION_MODE" == "UPDATE_FROM_OLD" ]]; then
...
echo "===== 5. VERIFY RUNTIME SURVIVES V278 ADAPTER BINDING BOUNDARY ====="
sleep 180
test "$(systemctl is-active "$SERVICE")" = "active"
...
echo "TDH_V279_ACTIVATION_COMPLETE"
