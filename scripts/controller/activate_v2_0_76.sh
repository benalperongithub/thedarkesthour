...
VERIFY_UNIT="/tmp/strategy-lab-supervisor-v2.1-v276-verify-${STAMP}.service"
PREFLIGHT_LOG="/tmp/tdh-v2.0.76-activation-preflight.log"
UNIT_UPDATED=false
ACTIVATION_MODE=""
...
echo "===== 4. INSTALL UNIT AND START v2.0.76 ====="
if [[ "$ACTIVATION_MODE" == "UPDATE_FROM_OLD" ]]; then
...
echo "===== 5. VERIFY RUNTIME SURVIVES PAST PACKET-A GLOBAL MEMORY FILTER BOUNDARY ====="
sleep 180
test "$(systemctl is-active "$SERVICE")" = "active"
...
echo "TDH_V276_ACTIVATION_COMPLETE"
