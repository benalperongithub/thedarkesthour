...
VERIFY_UNIT="/tmp/strategy-lab-supervisor-v2.1-v264-verify-${STAMP}.service"
PREFLIGHT_LOG="/tmp/tdh-v2.0.64-activation-preflight.log"
UNIT_UPDATED=false
ACTIVATION_MODE=""
...
echo "===== 4. INSTALL UNIT AND START v2.0.64 ====="
if [[ "$ACTIVATION_MODE" == "UPDATE_FROM_OLD" ]]; then
...
echo "TDH_V264_ACTIVATION_COMPLETE"
